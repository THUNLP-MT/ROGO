...
def get(seed=1,fixed_order=False,pc_valid=0.05):
    ...
    if not os.path.isdir('./data/Mixture/binary_mixture_7_Data/'):
        os.makedirs('./data/Mixture/binary_mixture_7_Data')
        # Pre-load
        for n,idx in enumerate(idata):
            if idx==0:
                ...
                dat={}
                dat['train']=datasets.CIFAR10('./data/Mixture/',train=True,download=True,transform=transforms.Compose([transforms.ToTensor(),transforms.Normalize(mean,std)]))
                dat['test']=datasets.CIFAR10('./data/Mixture/',train=False,download=True,transform=transforms.Compose([transforms.ToTensor(),transforms.Normalize(mean,std)]))
                data[n]={}
                data[n]['name']='cifar10'
                data[n]['ncla']=10
                for s in ['train','test']:
                ...
                std=(0.2752,)
                dat={}
                dat['train']=datasets.MNIST('./data/Mixture/',train=True,download=True,transform=transforms.Compose([
                    transforms.Pad(padding=2,fill=0),transforms.ToTensor(),transforms.Normalize(mean,std)]))
                dat['test']=datasets.MNIST('./data/Mixture/',train=False,download=True,transform=transforms.Compose([
                    transforms.Pad(padding=2,fill=0),transforms.ToTensor(),transforms.Normalize(mean,std)]))
                data[n]={}
                data[n]['name']='mnist'
                data[n]['ncla']=10
                ...
                std=[x/255 for x in [63.0,62.1,66.7]]
                dat={}
                dat['train']=datasets.CIFAR100('./data/Mixture/',train=True,download=True,transform=transforms.Compose([transforms.ToTensor(),transforms.Normalize(mean,std)]))
                dat['test']=datasets.CIFAR100('./data/Mixture/',train=False,download=True,transform=transforms.Compose([transforms.ToTensor(),transforms.Normalize(mean,std)]))
                data[n]={}
                ...
                dat = {}
                dat['train']=datasets.SVHN('./data/Mixture/',split='train',download=True,transform=transforms.Compose([transforms.ToTensor(),transforms.Normalize(mean,std)]))
                dat['test']=datasets.SVHN('./data/Mixture/',split='test',download=True,transform=transforms.Compose([transforms.ToTensor(),transforms.Normalize(mean,std)]))
                data[n] = {}
                data[n]['name']='svhn'
                data[n]['ncla']=10
                for s in ['train','test']:
                ...
                std=(0.3318,)
                dat={}
                dat['train']=FashionMNIST('./data/Mixture/fashion_mnist', train=True, download=True, transform=transforms.Compose([
                    transforms.Pad(padding=2, fill=0), transforms.ToTensor(),transforms.Normalize(mean, std)]))
                dat['test']=FashionMNIST('./data/Mixture/fashion_mnist', train=False, download=True, transform=transforms.Compose([
                    transforms.Pad(padding=2, fill=0), transforms.ToTensor(),transforms.Normalize(mean, std)]))
                data[n]={}
                ...
                dat={}
                dat['train']=Facescrub('./data/Mixture/facescrub', train=True, download=True, transform=transforms.Compose([transforms.ToTensor(),transforms.Normalize(mean,std)]))
                dat['test']=Facescrub('./data/Mixture/facescrub', train=False, download=True, transform=transforms.Compose([transforms.ToTensor(),transforms.Normalize(mean,std)]))
                ...
                std=(0.4501,)
                dat={}
                dat['train']=notMNIST('./data/Mixture/notmnist', train=True, download=True, transform=transforms.Compose([transforms.ToTensor(),transforms.Normalize(mean,std)]))
                dat['test']=notMNIST('./data/Mixture/notmnist', train=False, download=True, transform=transforms.Compose([transforms.ToTensor(),transforms.Normalize(mean,std)]))
                #mean, std = utils.compute_mean_std_dataset(dat['train']); print(mean,std); sys.exit()
                data[n]={}
            ...
            for s in ['train','test']:
                ...
                torch.save(data[n][s]['x'], os.path.join(os.path.expanduser('./data/Mixture/binary_mixture_7_Data'),'data'+str(idx)+s+'x.bin'))
                torch.save(data[n][s]['y'], os.path.join(os.path.expanduser('./data/Mixture/binary_mixture_7_Data'),'data'+str(idx)+s+'y.bin'))
        ...
        for n,idx in enumerate(idata):
            ...
            for s in ['train','test']:
                data[n][s]={'x':[],'y':[]}
                data[n][s]['x'] = torch.load(os.path.join(os.path.expanduser('./data/Mixture/binary_mixture_7_Data'),'data'+str(idx)+s+'x.bin'))
                data[n][s]['y'] = torch.load(os.path.join(os.path.expanduser('./data/Mixture/binary_mixture_7_Data'),'data'+str(idx)+s+'y.bin'))
