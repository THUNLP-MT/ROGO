...
def get_representation_matrix_ResNet18 (net, device, x, y=None): 
    ...
    for i in range(len(mat_final)):
        logging.info ('Layer {} : {}'.format(i+1,mat_final[i].shape))
    logging.info('-'*30)
    return mat_final    
...
def main(args):
    ...
    from dataloader import mixture as data_loader
...
if __name__ == "__main__":
    # Training parameters
    parser = argparse.ArgumentParser(description='Mixture with ROGO')
    ...
    parser.add_argument('--savename', type=str, default='save/Mixture/',
                        help='save path')
    parser.add_argument('--log_path', type=str, default='save/Mixture/train.log',
                        help='log path')
